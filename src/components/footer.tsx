...
import { Terminal, Shield, Lock, Server, Cpu, Database, Code, Network, Bug, 
         FileCode, CloudOff, Webhook, Wifi, UserCheck, Fingerprint } from 'lucide-react'
...
export default function Footer() {
    const securityIcons = [
        ...
        <Terminal key="terminal" size={100} color="#8b5cf6" strokeWidth={1.5} />,
        <Server key="server" size={100} color="#ef4444" strokeWidth={1.5} />,
        <Cpu key="cpu" size={100} color="#ec4899" strokeWidth={1.5} />,
        <Database key="database" size={100} color="#14b8a6" strokeWidth={1.5} />,
        <Code key="code" size={100} color="#6366f1" strokeWidth={1.5} />,
        <Network key="network" size={100} color="#f43f5e" strokeWidth={1.5} />,
        <FileCode key="filecode" size={100} color="#a855f7" strokeWidth={1.5} />,
        <CloudOff key="cloudoff" size={100} color="#d946ef" strokeWidth={1.5} />,
        <Webhook key="webhook" size={100} color="#84cc16" strokeWidth={1.5} />,
        <Wifi key="wifi" size={100} color="#3b82f6" strokeWidth={1.5} />,
        <UserCheck key="usercheck" size={100} color="#22c55e" strokeWidth={1.5} />,
        <Fingerprint key="fingerprint" size={100} color="#eab308" strokeWidth={1.5} />,
    ]
        ...
        <footer className="-mt-10 border-t border-zinc-800 bg-black py-10">
            <div className="container mx-auto px-4">
                ...
                <div className="mb-8 flex flex-col items-center justify-between gap-8 md:flex-row md:items-center">
                    ...
                    <div className="flex max-w-md flex-col justify-between pl-4 md:pl-8 ml-8">
                        <div className="mb-6">
                        ...
                        <div className="flex flex-1 flex-col">
                            <p className="mb-4 text-zinc-400">
                                ...
                                minds to tackle tomorrow's security challenges
                                today.
                            </p>
                    ...
                    <div className="relative -top-14 flex w-full max-w-[500px] justify-center py-4 md:mt-0 md:block -mb-24">
                ...
                <div className="mt-6 -mb-4 grid grid-cols-1 items-center gap-6 md:grid-cols-3">
                    ...
                    <div className="text-center text-base text-zinc-400 md:text-left ml-2">
                    ...
                    <div className="flex justify-center gap-6 ">
                        <Link
                            href="https://github.com/hackthebreach"
                        ...
                        <Link
                            href="https://linkedin.com/company/hackthebreach"
                            className="transition-colors hover:text-zinc-300"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
